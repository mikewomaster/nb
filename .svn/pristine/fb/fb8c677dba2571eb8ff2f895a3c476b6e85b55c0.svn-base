#ifndef MBUS_PROTOCOL_AUX_H
#define MBUS_PROTOCOL_AUX_H
//------------------------------------------------------------------------------
...
#ifdef _DEBUG_
#define MBUS_ERROR(...) DebugPrintf (__VA_ARGS__)
#define MBUS_DEBUG(...) DebugPrintf (__VA_ARGS__)
#else
#define MBUS_ERROR(...)
#define MBUS_DEBUG(...)
#endif
 ...
 */
mbus_record * mbus_record_new(void);
...
short mbus_scale_parse(int vif);
#endif
/**
